  ...
  var form_helper = {
    ...
    form: function(req) {
      ...
      fn.start = function(target, options) {
        ...
        // -------------------------------------------------- //
        settings.rest_method = settings.method;
        ...
        form += ">";
        form += _.template("<input type='hidden' name='_csrf' value='<%= auth %>' />", { auth: token() });
        form += _.template('<input type="hidden" value="<%= rest_method %>" name="_method" />', settings);
